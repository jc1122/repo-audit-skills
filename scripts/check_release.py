#!/usr/bin/env python3
"""Release checks for the repo-audit-skills umbrella package."""
...
REQUIRED_SKILLS = {
    "repo-audit-refactor-optimize": "repo-audit-refactor-optimize",
...
REQUIRED_SCRIPTS = {
    "repo-audit-refactor-optimize": ["scripts/check_skill_requirements.py"],
    ...
    "perf-benchmark": ["scripts/perf_benchmark_pipeline.py"],
}
...
def check_package(defects: list[str]) -> str:
    ...
    for path in ["bin/install-repo-audit-skills.js", "scripts/check_release.py", "scripts/check_skill_fixtures.py"]:
